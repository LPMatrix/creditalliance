<?php
  ...
  $transSql = mysqli_query($mysqli, "SELECT * FROM transactions WHERE fromAcc = $cusID AND status = 1");
?>
        ...
        <div class="main-content">
          ...
          <?php include("layout/navlinks.php"); ?>
            ...
            <div class="card col-sm-8">
              ...
              <div class="card-block container">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-striped m-b-0">
                    ...
                    <tbody>
                          <?php
                            while($pendingTrans = mysqli_fetch_array($transSql)){
                        ?>
                      <tr>
                        <td><?php echo $pendingTrans['transID']; ?></td>
                        <td><?php echo $pendingTrans['toAcc']; ?></td>
                        <td>$ <?php echo number_format($pendingTrans['amount'],2); ?></td>
                        <td><a href="completetransaction.php?id=<?php echo $pendingTrans['transID']; ?>" class="btn btn-success">Complete</a></td>
                      </tr>
                       <?php } ?>
                    </tbody>
                  </table>
              ...
              <div class="card-block container">
                <div class="m-b-1">
    	         <div id="myCalendar" class="vanilla-calendar" style="width: 100%"></div>   
                </div>
              </div>
            </div>
          </div>
    ...
    <script type="text/javascript">
      function btc(){
        Swal.fire({
            type: 'success',
            title: 'Receive BTC',
            text: 'Kindly request for bitcoin wallet from your accountant',
          })
      }
    </script>
    <script>
