            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="col-lg-6 col-md-offset-2">
                  <div class="card-block">
                    <form method="POST" action="server/updateprofile.php" name="transferForm" id="transferForm">
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="example-text-input" class="col-xs-2 col-form-label">Phone number:</label>
                        <div class="col-xs-10">
                          <input class="form-control" type="text" name="phoneno" value="<?php echo $user['phoneno']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label for="example-text-input" class="col-xs-2 col-form-label">Name :</label>
                        <div class="col-xs-10">
                          <input class="form-control" type="text" name="nokname" value="<?php echo $user['kinname']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label for="example-text-input" class="col-xs-2 col-form-label">Email :</label>
                        <div class="col-xs-10">
                          <input class="form-control" type="text" name="nokemail" value="<?php echo $user['kinemail']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label for="example-text-input" class="col-xs-2 col-form-label">Name :</label>
                        <div class="col-xs-10">
                          <input class="form-control" type="text" name="nokphoneno" value="<?php echo $user['kinphoneno']; ?>">
                        </div>
                      </div>
